	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.authorizeRequests()
				...
				.antMatchers(HttpMethod.PUT, "/api/diagnostico/{id}").permitAll()
				.antMatchers(HttpMethod.POST, "/api/email/sending-email").permitAll()
				.antMatchers(HttpMethod.POST, "/api/previa-diagnostico/salvar").permitAll()
				.antMatchers(HttpMethod.GET, "/api/previa-diagnostico/{id}").permitAll()
